...
- `README.md` and `docs/index.md` are incidental files with identical content (aside from front matter and internal link differences). Any additions, removals, or changes to any section must be applied consistently to both files.
