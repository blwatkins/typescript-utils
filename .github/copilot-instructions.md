...
- Both `README.md` and `docs/index.md` contain a "Repository Status Badges" section with identical badge content. Any additions, removals, or changes to badges must be applied consistently to both files.
